...
public class TaskAsserts {
    ...
    public static void assertTaskUpdatableFieldsEquals(Task expected, Task actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStoryPoints()).as("check storyPoints").isEqualTo(expected.getStoryPoints()))
            .satisfies(a -> assertThat(a.getEstimatedHours()).as("check estimatedHours").isEqualTo(expected.getEstimatedHours()))
            .satisfies(a -> assertThat(a.getSpentHours()).as("check spentHours").isEqualTo(expected.getSpentHours()))
    ...
    public static void assertTaskUpdatableRelationshipsEquals(Task expected, Task actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSprint()).as("check sprint").isEqualTo(expected.getSprint()))
            .satisfies(a -> assertThat(a.getMilestone()).as("check milestone").isEqualTo(expected.getMilestone()))
