...
import static com.fehmidev.projectmanagement.domain.NotificationAsserts.*;
...
class NotificationResourceIT {
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.title(UPDATED_TITLE).message(UPDATED_MESSAGE).type(UPDATED_TYPE).isRead(UPDATED_IS_READ);
