...
import static com.fehmidev.projectmanagement.domain.TaskAsserts.*;
...
class TaskResourceIT {
    ...
    private static final Double DEFAULT_ESTIMATED_HOURS = 0D;
    private static final Double UPDATED_ESTIMATED_HOURS = 1D;

    private static final Double DEFAULT_SPENT_HOURS = 0D;
    private static final Double UPDATED_SPENT_HOURS = 1D;
    ...
    public static Task createEntity() {
        return new Task()
            ...
            .spentHours(DEFAULT_SPENT_HOURS)
    ...
    public static Task createUpdatedEntity() {
        return new Task()
            ...
            .spentHours(UPDATED_SPENT_HOURS)
    ...
    @Test
    @Transactional
    void checkCompletionPercentageIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        task.setCompletionPercentage(null);
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].estimatedHours").value(hasItem(DEFAULT_ESTIMATED_HOURS)))
            .andExpect(jsonPath("$.[*].spentHours").value(hasItem(DEFAULT_SPENT_HOURS)))
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.estimatedHours").value(DEFAULT_ESTIMATED_HOURS))
            .andExpect(jsonPath("$.spentHours").value(DEFAULT_SPENT_HOURS))
