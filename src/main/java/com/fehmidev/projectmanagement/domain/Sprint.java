...
public class Sprint implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sprintSequenceGenerator")
    @SequenceGenerator(name = "sprintSequenceGenerator", sequenceName = "sprint_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
