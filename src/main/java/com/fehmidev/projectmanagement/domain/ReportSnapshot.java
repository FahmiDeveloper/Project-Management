...
public class ReportSnapshot implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "reportSnapshotSequenceGenerator")
    @SequenceGenerator(name = "reportSnapshotSequenceGenerator", sequenceName = "report_snapshot_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
