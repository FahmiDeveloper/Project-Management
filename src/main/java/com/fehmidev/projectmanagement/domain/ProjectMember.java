...
public class ProjectMember implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "projectMemberSequenceGenerator")
    @SequenceGenerator(name = "projectMemberSequenceGenerator", sequenceName = "project_member_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
