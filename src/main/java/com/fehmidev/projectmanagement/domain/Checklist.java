...
public class Checklist implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "checklistSequenceGenerator")
    @SequenceGenerator(name = "checklistSequenceGenerator", sequenceName = "checklist_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
    ...
    public Checklist createdDate(Instant createdDate) {
