...
public class Dashboard implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "dashboardSequenceGenerator")
    @SequenceGenerator(name = "dashboardSequenceGenerator", sequenceName = "dashboard_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
