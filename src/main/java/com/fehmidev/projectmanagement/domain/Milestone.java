...
public class Milestone implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "milestoneSequenceGenerator")
    @SequenceGenerator(name = "milestoneSequenceGenerator", sequenceName = "milestone_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
