...
public class TaskComment implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taskCommentSequenceGenerator")
    @SequenceGenerator(name = "taskCommentSequenceGenerator", sequenceName = "task_comment_sequence_generator", allocationSize = 50)
    @Column(name = "id")
    private Long id;
    ...
    public TaskComment createdDate(Instant createdDate) {
