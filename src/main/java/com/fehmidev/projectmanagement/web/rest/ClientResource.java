...
import com.fehmidev.projectmanagement.service.ClientService;
...
/**
 * REST controller for managing {@link com.fehmidev.projectmanagement.domain.Client}.
 */
@RestController
...
public class ClientResource {
    ...
    public ResponseEntity<List<ClientDTO>> getAllClients(
        ...
        Page<ClientDTO> page = clientService.findAll(companyName, pageable);
