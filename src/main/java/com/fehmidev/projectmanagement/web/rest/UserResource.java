...
import com.fehmidev.projectmanagement.web.rest.errors.EmailAlreadyUsedException;
import com.fehmidev.projectmanagement.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.fehmidev.projectmanagement.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<List<AdminUserDTO>> getAllUsers(
        ...
        final Page<AdminUserDTO> page = userService.getAllManagedUsers(login, email, pageable);
