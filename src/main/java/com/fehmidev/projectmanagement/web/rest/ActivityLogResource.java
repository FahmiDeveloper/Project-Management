...
/**
 * REST controller for managing {@link com.fehmidev.projectmanagement.domain.ActivityLog}.
 */
@RestController
...
public class ActivityLogResource {
    ...
    public ResponseEntity<ActivityLogDTO> createActivityLog(@Valid @RequestBody ActivityLogDTO activityLogDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/activity-logs/" + activityLogDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, activityLogDTO.getId().toString()))
            .body(activityLogDTO);
    }
    ...
    public ResponseEntity<ActivityLogDTO> updateActivityLog(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, activityLogDTO.getId().toString()))
            .body(activityLogDTO);
    }
    ...
    public ResponseEntity<ActivityLogDTO> partialUpdateActivityLog(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, activityLogDTO.getId().toString())
        );
    }
