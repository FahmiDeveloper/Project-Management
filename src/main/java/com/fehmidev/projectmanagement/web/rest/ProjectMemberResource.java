...
import com.fehmidev.projectmanagement.service.ProjectMemberService;
...
/**
 * REST controller for managing {@link com.fehmidev.projectmanagement.domain.ProjectMember}.
 */
@RestController
...
public class ProjectMemberResource {
    ...
    public ResponseEntity<ProjectMemberDTO> createProjectMember(@Valid @RequestBody ProjectMemberDTO projectMemberDTO)
        ...
        return ResponseEntity.created(new URI("/api/project-members/" + projectMemberDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, projectMemberDTO.getId().toString()))
    ...
    public ResponseEntity<List<ProjectMemberDTO>> getAllProjectMembers(
        ...
        if (eagerload) {
            page = projectMemberService.findAllWithEagerRelationships(projectId, employeeId, role, pageable);
        } else {
            page = projectMemberService.findAll(projectId, employeeId, role, pageable);
        }
     ...
     */
    @GetMapping("/count")
    public ResponseEntity<Long> countProjectMembers(@RequestParam(name = "projectId", required = false) Long projectId) {
        LOG.debug("REST request to count ProjectMembers by projectId: {}", projectId);
        long count = projectId != null ? projectMemberRepository.countByProjectId(projectId) : projectMemberRepository.count();
