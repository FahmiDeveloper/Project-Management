...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../sprint.test-samples';

import { RestSprint, SprintService } from './sprint.service';

const requireRestSample: RestSprint = {
