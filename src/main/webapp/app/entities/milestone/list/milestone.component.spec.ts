...
import { sampleWithRequiredData } from '../milestone.test-samples';
...
describe('Milestone Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.milestones()[0]).toEqual(expect.objectContaining({ id: 27104 }));
  });

  describe('trackId', () => {
    it('should forward to milestoneService', () => {
      const entity = { id: 27104 };
      jest.spyOn(service, 'getMilestoneIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMilestoneIdentifier).toHaveBeenCalledWith(entity);
