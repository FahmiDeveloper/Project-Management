...
import { MilestoneService, RestMilestone } from './milestone.service';

const requireRestSample: RestMilestone = {
...
describe('Milestone Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Milestone', () => {
      ...
      service.create(milestone).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Milestone', () => {
      ...
      service.update(milestone).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addMilestoneToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(milestone);
        expect(expectedResult).toContain(milestone2);
      });
