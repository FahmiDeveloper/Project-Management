...
import { sampleWithRequiredData } from '../task-comment.test-samples';
...
describe('TaskComment Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.taskComments()[0]).toEqual(expect.objectContaining({ id: 17531 }));
  });

  describe('trackId', () => {
    it('should forward to taskCommentService', () => {
      const entity = { id: 17531 };
      jest.spyOn(service, 'getTaskCommentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTaskCommentIdentifier).toHaveBeenCalledWith(entity);
