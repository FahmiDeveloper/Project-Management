...
import taskCommentResolve from './task-comment-routing-resolve.service';

describe('TaskComment routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: TaskCommentService;
  let resultTaskComment: ITaskComment | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITaskComment returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        taskCommentResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITaskComment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
