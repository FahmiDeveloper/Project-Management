...
import { sampleWithRequiredData } from '../checklist-item.test-samples';
...
describe('ChecklistItem Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.checklistItems()[0]).toEqual(expect.objectContaining({ id: 474 }));
  });

  describe('trackId', () => {
    it('should forward to checklistItemService', () => {
      const entity = { id: 474 };
      jest.spyOn(service, 'getChecklistItemIdentifier');
      const id = comp.trackId(entity);
      expect(service.getChecklistItemIdentifier).toHaveBeenCalledWith(entity);
