...
export class ReportSnapshotComponent implements OnInit {
  ...
  protected readonly reportSnapshotService = inject(ReportSnapshotService);
  ...
  delete(reportSnapshot: IReportSnapshot): void {
    const modalRef = this.modalService.open(ReportSnapshotDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.reportSnapshot = reportSnapshot;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.reportSnapshots.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IReportSnapshot[] | null): IReportSnapshot[] {
    return data ?? [];
  }
